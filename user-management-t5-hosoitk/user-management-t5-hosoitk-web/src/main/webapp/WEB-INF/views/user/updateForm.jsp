		...
		<form:form action="${pageContext.request.contextPath}/user/update"
			...
			<table>
				<tr>
					...
					<td>
					    <form:input path="userId" cssErrorClass="error-input" value="${f:h(userForm.userId)}" />
				...
				<tr>
					...
					<td>
					    <form:input path="username" cssErrorClass="error-input" value="${f:h(userForm.username)}" />
				...
				<tr>
					...
					<td>
					    <fmt:formatDate value="${userForm.birthday}" pattern="yyyy-MM-dd" var="formattedBirthday" />
						<input type="date" id="birthday" name="birthday" value=" value="${f:h(userForm.username)}" >
				...
				<tr>
					...
					<td>
					    <form:input path="address" cssErrorClass="error-input" value="${f:h(userForm.address)}" />
				...
				<tr>
					...
					<td>
					    <form:input path="telNum" cssErrorClass="error-input" value="${f:h(userForm.telNum)}" />
					    <form:errors path="telNum" cssClass="error-messages" /></td>
				</tr>
				<tr>
					<td><form:label path="roles" cssErrorClass="error-label">roles</form:label></td>
					<td>
					    <form:input path="roles" cssErrorClass="error-input" />
					    <form:errors path="roles" cssClass="error-messages" value="${f:h(userForm.roles)}"/>
					</td>
				</tr>
				<tr>
					<td><form:label path="noEncodedPassword" cssErrorClass="error-label">password</form:label></td>
					<td>
					    <form:password path="noEncodedPassword" cssErrorClass="error-input" />
						<form:errors path="noEncodedPassword" cssClass="error-messages" />
				    </td>
				</tr>
				<tr>
